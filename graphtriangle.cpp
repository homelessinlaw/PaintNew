...
void GraphTriangle::draw (QPainter& painter)
{
    QPoint pointpairs[] = {
        {pos.x(), pos.y() + h},
        {pos.x() + w/2, pos.y()},
    ...
    painter.drawLines(pointpairs, 3);

}

std::vector<QPoint> GraphTriangle::getCoordinatest() const
{
    return {
        { pos.x() + w/2, pos.y() },
        { pos.x(), pos.y() + h },
...
bool GraphTriangle::isPointInFigure(QPoint point) const
{
